...
public class DataConstants {
    ...
    public static final String STATION_MANAGE_INSERT_URL = "/stationManage/insertStationManage";

    public static final String STATION_MANAGE_DELETE_URL = "/stationManage/deleteStationManage";

    public static final String DNS_MANAGE_INSERT_URL = "/dnsManage/insertDnsManage";

    public static final String DNS_MANAGE_DELETE_URL = "/dnsManage/deleteDnsManage";
