...
CREATE TABLE IF NOT EXISTS `nmpl_update_info` (
                                                  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
                                                  `table_name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '更新表名',
    `operation_type` varchar(8) DEFAULT NULL COMMENT '操作类型：新增:1 修改:2 删除:3 ',
    `create_user` varchar(20) DEFAULT NULL COMMENT '创建人',
    ...
    `is_exist` tinyint(1) DEFAULT '1' COMMENT '1:存在 0:删除',
    PRIMARY KEY (`id`)
    ) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='数据更新信息表';
