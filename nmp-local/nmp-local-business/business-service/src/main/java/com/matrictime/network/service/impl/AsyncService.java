...
public class AsyncService{
    ...
    public void testInsertAlarmData(){
        ...
        for (int i = 0; i < 50; i++) {
            ...
            alarmInfoList.add(AlarmInfo.builder().alarmSourceIp("8343028466324107264").alarmSourceIp("192.168.72.20").alarmUploadTime(DateUtils.addDayForNow(-i)).alarmContentType("5").alarmSourceType("01").alarmLevel("1").alarmContent("数据库断开").build());
            alarmInfoList.add(AlarmInfo.builder().alarmSourceIp("8343031749797244928").alarmSourceIp("192.168.72.24").alarmUploadTime(DateUtils.addDayForNow(-i)).alarmContentType("5").alarmSourceType("02").alarmLevel("2").alarmContent("线程中断").build());
            alarmInfoList.add(AlarmInfo.builder().alarmSourceIp("8343031749797244928").alarmSourceIp("192.168.72.24").alarmUploadTime(DateUtils.addDayForNow(-i)).alarmContentType("5").alarmSourceType("02").alarmLevel("3").alarmContent("系统异常").build());
            alarmInfoList.add(AlarmInfo.builder().alarmSourceIp("8343031749797244928").alarmSourceIp("192.168.72.24").alarmUploadTime(DateUtils.addDayForNow(-i)).alarmContentType("5").alarmSourceType("02").alarmLevel("1").alarmContent("系统塌了").build());
            alarmInfoList.add(AlarmInfo.builder().alarmSourceIp("8343028679881289728").alarmSourceIp("192.168.72.23").alarmUploadTime(DateUtils.addDayForNow(-i)).alarmContentType("5").alarmSourceType("11").alarmLevel("1").alarmContent("密钥告警").build());
            alarmInfoList.add(AlarmInfo.builder().alarmSourceIp("8343028679881289728").alarmSourceIp("192.168.72.23").alarmUploadTime(DateUtils.addDayForNow(-i)).alarmContentType("5").alarmSourceType("11").alarmLevel("2").alarmContent("系统塌了").build());
            alarmInfoList.add(AlarmInfo.builder().alarmSourceIp("8343028679881289728").alarmSourceIp("192.168.72.23").alarmUploadTime(DateUtils.addDayForNow(-i)).alarmContentType("5").alarmSourceType("11").alarmLevel("3").alarmContent("日志过大").build());
            alarmInfoList.add(AlarmInfo.builder().alarmSourceIp("8343028679881289728").alarmSourceIp("192.168.72.23").alarmUploadTime(DateUtils.addDayForNow(-i)).alarmContentType("5").alarmSourceType("11").alarmLevel("3").alarmContent("系统塌了").build());
