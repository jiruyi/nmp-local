...
Source Server         : 192.168.72.14
Source Server Version : 80026
Source Host           : 192.168.72.14:3306
Source Database       : nmp_local
...
INSERT INTO `nmpl_menu` (`menu_id`, `menu_name`, `parent_menu_id`, `url`, `is_frame`, `menu_type`, `menu_status`, `perms_code`, `remark`, `is_exist`)values (10, '查看角色', 7, NULL, 0, 2, 1, 'sys:role:query', NULL, 1);
...
INSERT INTO `nmpl_menu` (`menu_id`, `menu_name`, `parent_menu_id`, `url`, `is_frame`, `menu_type`, `menu_status`, `perms_code`, `remark`, `is_exist`)values (15, '查看用户', 12, NULL, 0, 2, 1, 'sys:user:query', NULL, 1);
...
INSERT INTO `nmpl_menu` (`menu_id`, `menu_name`, `parent_menu_id`, `url`, `is_frame`, `menu_type`, `menu_status`, `perms_code`, `remark`, `is_exist`)values (22, '查看大区', 18, NULL, 0, 2, 1, 'sys:region:query', NULL, 1);
...
INSERT INTO `nmpl_menu` (`menu_id`, `menu_name`, `parent_menu_id`, `url`, `is_frame`, `menu_type`, `menu_status`, `perms_code`, `remark`, `is_exist`)values (26, '查看小区', 19, NULL, 0, 2, 1, 'sys:village:query', NULL, 1);
...
INSERT INTO `nmpl_menu` (`menu_id`, `menu_name`, `parent_menu_id`, `url`, `is_frame`, `menu_type`, `menu_status`, `perms_code`, `remark`, `is_exist`)values (35, '查看基站', 29, NULL, 0, 2, 1, 'sys:station:query', NULL, 1);
...
INSERT INTO `nmpl_menu` (`menu_id`, `menu_name`, `parent_menu_id`, `url`, `is_frame`, `menu_type`, `menu_status`, `perms_code`, `remark`, `is_exist`)values (39, '查看分发机', 30, NULL, 0, 2, 1, 'sys:dispenser:query', NULL, 1);
...
INSERT INTO `nmpl_menu` (`menu_id`, `menu_name`, `parent_menu_id`, `url`, `is_frame`, `menu_type`, `menu_status`, `perms_code`, `remark`, `is_exist`)values (43, '查看生成机', 31, NULL, 0, 2, 1, 'sys:generator:query', NULL, 1);
...
INSERT INTO `nmpl_menu` (`menu_id`, `menu_name`, `parent_menu_id`, `url`, `is_frame`, `menu_type`, `menu_status`, `perms_code`, `remark`, `is_exist`)values (47, '查看缓存机', 32, NULL, 0, 2, 1, 'sys:cache:query', NULL, 1);
...
INSERT INTO `nmpl_menu` (`menu_id`, `menu_name`, `parent_menu_id`, `url`, `is_frame`, `menu_type`, `menu_status`, `perms_code`, `remark`, `is_exist`)values (53, '查看链路', 50, NULL, 0, 2, 1, 'sys:link:query', NULL, 1);
...
INSERT INTO `nmpl_menu` (`menu_id`, `menu_name`, `parent_menu_id`, `url`, `is_frame`, `menu_type`, `menu_status`, `perms_code`, `remark`, `is_exist`)values (59, '查看路由', 56, NULL, 0, 2, 1, 'sys:route:query', NULL, 1);
...
INSERT INTO `nmpl_menu` (`menu_id`, `menu_name`, `parent_menu_id`, `url`, `is_frame`, `menu_type`, `menu_status`, `perms_code`, `remark`, `is_exist`)values (66, '查看参数', 62, NULL, 0, 2, 1, 'sys:parm:query', NULL, 1);
...
INSERT INTO `nmpl_menu` (`menu_id`, `menu_name`, `parent_menu_id`, `url`, `is_frame`, `menu_type`, `menu_status`, `perms_code`, `remark`, `is_exist`)values (69, '查看权限', 63, NULL, 0, 2, 1, 'sys:power:query', NULL, 1);
...
INSERT INTO `nmpl_menu` (`menu_id`, `menu_name`, `parent_menu_id`, `url`, `is_frame`, `menu_type`, `menu_status`, `perms_code`, `remark`, `is_exist`)values (72, '设备查看', 71, NULL, 0, 2, 1, 'sys:sign:query', NULL, 1);
...
INSERT INTO `nmpl_menu` (`menu_id`, `menu_name`, `parent_menu_id`, `url`, `is_frame`, `menu_type`, `menu_status`, `perms_code`, `remark`, `is_exist`)values (83, '查看登录日志', 80, NULL, 0, 2, 1, 'sys:loginLog:query', NULL, 1);
INSERT INTO `nmpl_menu` (`menu_id`, `menu_name`, `parent_menu_id`, `url`, `is_frame`, `menu_type`, `menu_status`, `perms_code`, `remark`, `is_exist`)values (84, '查看操作日志', 81, NULL, 0, 2, 1, 'sys:operateLog:query', NULL, 1);
INSERT INTO `nmpl_menu` (`menu_id`, `menu_name`, `parent_menu_id`, `url`, `is_frame`, `menu_type`, `menu_status`, `perms_code`, `remark`, `is_exist`)values (85, '查看系统日志', 82, NULL, 0, 2, 1, 'sys:sysLog:query', NULL, 1);
...
INSERT INTO `nmpl_menu` (`menu_id`, `menu_name`, `parent_menu_id`, `url`, `is_frame`, `menu_type`, `menu_status`, `perms_code`, `remark`, `is_exist`)values (91, '查看基站统计数据', 87, NULL, 0, 2, 1, 'sys:stationData:query', NULL, 1);
INSERT INTO `nmpl_menu` (`menu_id`, `menu_name`, `parent_menu_id`, `url`, `is_frame`, `menu_type`, `menu_status`, `perms_code`, `remark`, `is_exist`)values (92, '查看分发机统计数据', 88, NULL, 0, 2, 1, 'sys:dispenserData:query', NULL, 1);
INSERT INTO `nmpl_menu` (`menu_id`, `menu_name`, `parent_menu_id`, `url`, `is_frame`, `menu_type`, `menu_status`, `perms_code`, `remark`, `is_exist`)values (93, '查看生成机统计数据', 89, NULL, 0, 2, 1, 'sys:generatorData:query', NULL, 1);
INSERT INTO `nmpl_menu` (`menu_id`, `menu_name`, `parent_menu_id`, `url`, `is_frame`, `menu_type`, `menu_status`, `perms_code`, `remark`, `is_exist`)values (94, '查看缓存机统计数据', 90, NULL, 0, 2, 1, 'sys:cacheData:query', NULL, 1);
...
INSERT INTO `nmpl_menu` (`menu_id`, `menu_name`, `parent_menu_id`, `url`, `is_frame`, `menu_type`, `menu_status`, `perms_code`, `remark`, `is_exist`)values (97, '查看话单', 96, NULL, 0, 2, 1, 'sys:bill:query', NULL, 1);
...
INSERT INTO `nmpl_menu` (`menu_id`, `menu_name`, `parent_menu_id`, `url`, `is_frame`, `menu_type`, `menu_status`, `perms_code`, `remark`, `is_exist`)values (106, '运营商查看', 2, NULL, 0, 2, 1, 'sys:operator:query', NULL, 1);
INSERT INTO `nmpl_menu` (`menu_id`, `menu_name`, `parent_menu_id`, `url`, `is_frame`, `menu_type`, `menu_status`, `perms_code`, `remark`, `is_exist`)values (108, '监控轮询展示查看', 71, NULL, 0, 2, 1, 'sys:monitor:query', NULL, 1);
INSERT INTO `nmpl_menu` (`menu_id`, `menu_name`, `parent_menu_id`, `url`, `is_frame`, `menu_type`, `menu_status`, `perms_code`, `remark`, `is_exist`)values (109, '总带宽负载变化查看', 71, NULL, 0, 2, 1, 'sys:monitor:totalload', NULL, 1);
INSERT INTO `nmpl_menu` (`menu_id`, `menu_name`, `parent_menu_id`, `url`, `is_frame`, `menu_type`, `menu_status`, `perms_code`, `remark`, `is_exist`)values (110, '信令轮询分页查看', 74, NULL, 0, 2, 1, 'sys:sign:query', NULL, 1);
INSERT INTO `nmpl_menu` (`menu_id`, `menu_name`, `parent_menu_id`, `url`, `is_frame`, `menu_type`, `menu_status`, `perms_code`, `remark`, `is_exist`)values (112, '信令查看已选设备列表', 74, NULL, 0, 2, 1, 'sys:sign:selectDeviceIds', NULL, 1);
INSERT INTO `nmpl_menu` (`menu_id`, `menu_name`, `parent_menu_id`, `url`, `is_frame`, `menu_type`, `menu_status`, `perms_code`, `remark`, `is_exist`)values (113, '查看信令设备列表', 74, NULL, 0, 2, 1, 'sys:sign:deviceIds', NULL, 1);
INSERT INTO `nmpl_menu` (`menu_id`, `menu_name`, `parent_menu_id`, `url`, `is_frame`, `menu_type`, `menu_status`, `perms_code`, `remark`, `is_exist`)values (114, '查看版本文件列表', 99, NULL, 0, 2, 1, 'sys:version:fileList', NULL, 1);
...
INSERT INTO `nmpl_menu` (`menu_id`, `menu_name`, `parent_menu_id`, `url`, `is_frame`, `menu_type`, `menu_status`, `perms_code`, `remark`, `is_exist`)values (117, '版本列表查看', 99, NULL, 0, 2, 1, 'sys:version:list', NULL, 1);
...
INSERT INTO `nmpl_menu` (`menu_id`, `menu_name`, `parent_menu_id`, `url`, `is_frame`, `menu_type`, `menu_status`, `perms_code`, `remark`, `is_exist`)values (123, '查看离线分发机', 120, NULL, 0, 2, 1, 'sys:sorter:query', NULL, 1);
...
INSERT INTO `nmpl_menu` (`menu_id`, `menu_name`, `parent_menu_id`, `url`, `is_frame`, `menu_type`, `menu_status`, `perms_code`, `remark`, `is_exist`)values (130, '查看一体机', 127, NULL, 0, 2, 1, 'sys:pc:query', NULL, 1);
...
INSERT INTO `nmpl_menu` (`menu_id`, `menu_name`, `parent_menu_id`, `url`, `is_frame`, `menu_type`, `menu_status`, `perms_code`, `remark`, `is_exist`)values (137, '查看备用机', 133, NULL, 0, 2, 1, 'sys:deviceExtra:query', NULL, 1);
