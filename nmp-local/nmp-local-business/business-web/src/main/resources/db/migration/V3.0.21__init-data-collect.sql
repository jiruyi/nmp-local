...
INSERT INTO nmp_local.nmpl_config (device_type, config_name, config_code, config_value, default_value, unit, status) VALUES
    ('01', '加强密度配置（128bit-128k）', 'as0001', '1：1', '1：1', null, 0),
    ('01', '加强密度配置（>128k ）', 'as0002', '1：32', '1：32', null, 0),
    ('01', '话单上报', 'as0003', '60', '60', 's', 0),
    ('01', '基站状态上报', 'as0004', '1', '1', 's', 0),
    ('01', '通信状态上报', 'as0005', '60', '60', 's', 0),
    ('11', '生成密钥量', 'kc0001', '10', '10', 'T', 0),
    ('11', '分发密钥量', 'kc0002', '1', '1', 'T', 0),
    ('20', '采集周期', 'dc0001', '1800', '1800', 's', 0),
    ('20', '上报周期', 'dc0002', '1800', '1800', 's', 0),
...
CREATE TABLE IF NOT EXISTS `nmpl_data_push_record` (
     ...
     `update_time` datetime(2) DEFAULT CURRENT_TIMESTAMP(2) ON UPDATE CURRENT_TIMESTAMP(2) COMMENT '更新时间',
     PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT '数据推送记录表';
