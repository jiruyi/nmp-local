...
INSERT INTO nmp_local.nmpl_config (device_type, config_name, config_code, config_value, default_value, unit, status) VALUES
    ('01', '加强密度配置（128bit-128k）', 'bs0001', '1：1', '1：1', null, 0),
    ('01', '加强密度配置（>128k ）', 'bs0002', '1：32', '1：32', null, 0),
    ('01', '话单上报', 'bs0003', '60', '60', 's', 0),
    ('01', '基站状态上报', 'bs0004', '1', '1', 's', 0),
    ('01', '通信状态上报', 'bs0005', '60', '60', 's', 0),
