...
INSERT INTO `nmp_local`.`nmpl_menu` ( `menu_id`,`menu_name`, `parent_menu_id`, `url`, `is_frame`, `menu_type`, `menu_status`, `perms_code`,  `remark`, `is_exist`, `icon`, `permission`, `component`) VALUES ( '165','系统终端监控', '70', '/systemterminal', '0', '1', '1', 'sys:monitor:system',  NULL, '1', '', '0', 'monitor/system');
