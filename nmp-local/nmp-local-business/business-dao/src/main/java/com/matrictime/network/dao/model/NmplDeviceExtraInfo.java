 ...
 */
@Data
public class NmplDeviceExtraInfo {
    /**
     * 主键
     */
    private Long id;
    ...
    /**
     * 设备类型 00:基站 01:密钥分发机 02:生成机 03:缓存机
     */
    ...
    public void setRelDeviceId(String relDeviceId) {
        this.relDeviceId = relDeviceId == null ? null : relDeviceId.trim();
    }
