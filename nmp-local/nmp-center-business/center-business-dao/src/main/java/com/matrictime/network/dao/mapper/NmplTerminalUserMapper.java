...
public interface NmplTerminalUserMapper {
    ...
    int deleteByPrimaryKey(@Param("terminalStatus") String terminalStatus, @Param("companyNetworkId") String companyNetworkId, @Param("userType") String userType);
    ...
    NmplTerminalUser selectByPrimaryKey(@Param("terminalStatus") String terminalStatus, @Param("companyNetworkId") String companyNetworkId, @Param("userType") String userType);
