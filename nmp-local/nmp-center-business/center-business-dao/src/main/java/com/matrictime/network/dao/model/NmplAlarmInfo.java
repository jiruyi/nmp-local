...
public class NmplAlarmInfo {
    ...
    public String getAlarmAreaCode() {
        return alarmAreaCode;
    }

    public void setAlarmAreaCode(String alarmAreaCode) {
        this.alarmAreaCode = alarmAreaCode == null ? null : alarmAreaCode.trim();
    }
