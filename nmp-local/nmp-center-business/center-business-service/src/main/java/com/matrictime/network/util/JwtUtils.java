...
public class JwtUtils {
     ...
     */
    public static String createToken(NmplUser networkUser){
        return  JWT.create().withAudience(String.valueOf(networkUser.getUserId()))
                .withIssuedAt(new Date())
                .withClaim("nickName",networkUser.getNickName())
                .withClaim("loginAccount",networkUser.getLoginAccount())
                .withClaim("userId",String.valueOf(networkUser.getUserId()))
                .withClaim("phone",networkUser.getPhoneNumber())
                .withClaim("roleId",networkUser.getRoleId())
