...
import com.matrictime.network.service.SystemHeartService;
...
@Service("system_heartbeat")
@Slf4j
public class SystemHeartServiceImpl implements SystemHeartService, DataHandlerService {
    ...
    public Result<Integer> receiveStationSummary(StationSummaryVo stationSummaryVo) {
        ...
        try {
            ...
            log.info("receiveSystemHeart:{}",e.getMessage());
