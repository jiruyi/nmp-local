...
import com.matrictime.network.service.StationService;
...
@Service("station")
@Slf4j
public class StationServiceImpl implements StationService, DataHandlerService {
    ...
    public Result<Integer> receiveStationSummary(StationSummaryVo stationSummaryVo) {
        ...
        try {
            ...
            log.info("receiveStation:{}",e.getMessage());
