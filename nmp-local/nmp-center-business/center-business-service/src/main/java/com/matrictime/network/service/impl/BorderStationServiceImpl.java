...
import com.matrictime.network.service.BorderStationService;
 ...
 * @date 2023/9/4.
 */
@Service("border_station")
@Slf4j
public class BorderStationServiceImpl implements BorderStationService, DataHandlerService {
    ...
    public Result<Integer> receiveStationSummary(StationSummaryVo stationSummaryVo) {
        ...
        try {
            ...
            log.info("receiveBorderStation:{}",e.getMessage());
